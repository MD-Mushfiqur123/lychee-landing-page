...
func TestParseName(t *testing.T) {
	cases := []struct {
		...
		{"lychee.com/library/_:latest", Name{h: "lychee.com", n: "library", m: "_", t: "latest"}},
...
func TestMerge(t *testing.T) {
	cases := []struct {
		...
		{"bmizerany/smol", "lychee.com/library/_:latest", "lychee.com/bmizerany/smol:latest"},
		{"localhost:8080/bmizerany/smol", "lychee.com/library/_:latest", "localhost:8080/bmizerany/smol:latest"},
	}
	for _, tt := range cases {
