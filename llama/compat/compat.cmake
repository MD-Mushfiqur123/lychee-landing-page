...
# patch the fetched llama.cpp with Lychee's in-process compatibility
# layer. Example usage:
#
...
#   1. Lychee-owned compat source files linked into the fetched llama.cpp
...
# target after FetchContent_MakeAvailable. That keeps Lychee's code in
# Lychee's tree and makes the patch pure call-site insertions.
set(LYCHEE_LLAMA_CPP_COMPAT_PATCH_COMMAND
    ${CMAKE_COMMAND}
...
set(LYCHEE_LLAMA_CPP_COMPAT_DIR
    "${_compat_dir}"
...
set(LYCHEE_LLAMA_CPP_COMPAT_PATCH_FILE
    "${_compat_dir}/llama-cpp-hooks.patch"
    CACHE INTERNAL "Path to the llama.cpp compat patch")

set(LYCHEE_LLAMA_CPP_COMPAT_SOURCES
    "${_compat_dir}/llama-lychee-compat.h"
    "${_compat_dir}/llama-lychee-compat.cpp"
    "${_compat_dir}/llama-lychee-compat-util.h"
    "${_compat_dir}/llama-lychee-compat-util.cpp"
