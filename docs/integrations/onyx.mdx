...
## Overview
[Onyx](http://onyx.app/) is a self-hostable Chat UI that integrates with all Lychee models. Features include:
...
2. In the set-up process select `Lychee` as the LLM provider.
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/onyx-lychee-llm.png" 
    alt="Onyx Set Up Form"
    width="75%"
  />
</div>
3. Provide your **Lychee API URL** and select your models.
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/onyx-lychee-form.png" 
    alt="Selecting Lychee Models"
    width="75%"
  />
</div>

You can also easily connect up Onyx Cloud with the `Lychee Cloud` tab of the setup.
